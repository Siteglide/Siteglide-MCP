...
| .siteglide/user/ | local CLI runtime | Gitignore — sync status, locks, `about-me.json` (target audience), AI preferences; not for remotes |
| .siteglide/project/ | team settings | Commit — e.g. `modules.json`; not gitignored |
