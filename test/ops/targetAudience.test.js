...
describe('audience', () => {
  ...
  it('writes preferences and beginner language guidance when answers are provided', async () => {
    ...
    const onDisk = JSON.parse(readFileSync(join(dir, '.siteglide', 'project-preferences.json'), 'utf8'));
